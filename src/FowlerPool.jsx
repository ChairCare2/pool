// FOWLER BROTHERS POOL SERVICE — Full Feature v3.0
// Admin: admin / Pa55w0rd | Netlify Forms ready | window.storage persistence
...
@keyframes counterIn{from{opacity:0;transform:translateY(18px) scale(.9)}to{opacity:1;transform:translateY(0) scale(1)}}
...
// Pool-specific images using Unsplash Collections (all verified pool photos)
const IMGS = {
  hero:  "https://images.unsplash.com/photo-1575429198097-0414ec08e8cd?auto=format&fit=crop&w=1920&q=80",
  hero2: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=1920&q=80",
  about: "https://images.unsplash.com/photo-1571902943202-507ec2618e8f?auto=format&fit=crop&w=900&q=80",
  pool1: "https://images.unsplash.com/photo-1596461404969-9ae70f2830c1?auto=format&fit=crop&w=800&q=80",
  pool2: "https://images.unsplash.com/photo-1562778612-e1e0cda9915c?auto=format&fit=crop&w=800&q=80",
  pool3: "https://images.unsplash.com/photo-1615729947596-a598e5de0ab3?auto=format&fit=crop&w=800&q=80",
  pool4: "https://images.unsplash.com/photo-1504370805625-d32c54b16100?auto=format&fit=crop&w=800&q=80",
  equip: "https://images.unsplash.com/photo-1581244277943-fe4a9c777189?auto=format&fit=crop&w=800&q=80",
  before:"https://images.unsplash.com/photo-1600566752355-35792bedcfea?auto=format&fit=crop&w=800&q=80",
  after: "https://images.unsplash.com/photo-1575429198097-0414ec08e8cd?auto=format&fit=crop&w=800&q=80",
  team:  "https://images.unsplash.com/photo-1530268729831-4b0b9e170218?auto=format&fit=crop&w=800&q=80",
  bg2:   "https://images.unsplash.com/photo-1519452575417-564c1401ecc0?auto=format&fit=crop&w=1920&q=80",
};
const POOL_PHOTOS = [
...
const DEF_GALLERY = [
  {id:1,url:POOL_PHOTOS[0],title:"Crystal Clear Results",category:"After",featured:true},
  {id:2,url:POOL_PHOTOS[1],title:"Pool Maintenance Service",category:"Service",featured:false},
  {id:3,url:POOL_PHOTOS[2],title:"Backyard Oasis Restored",category:"After",featured:true},
  {id:4,url:POOL_PHOTOS[3],title:"Equipment Repair Complete",category:"Equipment",featured:false},
  {id:5,url:POOL_PHOTOS[4],title:"Pump System Service",category:"Equipment",featured:false},
  {id:6,url:POOL_PHOTOS[8],title:"Before: Algae Cleanup",category:"Before",featured:false},
  {id:7,url:POOL_PHOTOS[5],title:"After: Cleanup Complete",category:"After",featured:true},
  {id:8,url:POOL_PHOTOS[6],title:"Routine Maintenance Visit",category:"Service",featured:false},
  {id:9,url:POOL_PHOTOS[7],title:"On-Site Service Call",category:"Service",featured:false},
];
const DEF_TESTI = [
...
const SVC = [
  {id:1,icon:"🔧",title:"Pool Repairs",tag:"Fix It Right, Fix It Fast",color:"#0077C8",
   desc:"From minor issues to complex repairs, we diagnose and solve pool problems fast.",
   detail:"Pool problems don't take days off. Whether it's a cracked fitting, broken skimmer, or a mystery issue, we bring 8 years of hands-on experience to every repair.",
   signs:["Water loss or visible cracks","Pool won't hold chemistry","Unusual equipment sounds","Damage to surfaces or fittings"]},
  {id:2,icon:"⚙️",title:"Pump & Filter Repair",tag:"The Heart of Your Pool System",color:"#00A8E8",
   desc:"We diagnose pump and filter performance issues, repair equipment, and restore proper flow.",
   detail:"A struggling pump means cloudy water and bigger problems ahead. We inspect the full circulation system and repair or replace components to get your water moving properly.",
   signs:["Loud or unusual pump noises","Weak water flow or pressure","Water leaking around pump","Cloudy water that won't clear"]},
  {id:3,icon:"🔍",title:"Leak Detection",tag:"Stop the Drain on Your Budget",color:"#006494",
   desc:"Losing water faster than normal? We find leaks and guide you toward efficient repair.",
   detail:"A pool leak can cost hundreds in water and chemicals before you realize it. We use methodical inspection to find the source and help you address it properly.",
   signs:["Losing more than ¼\" per day","Wet spots around equipment","Adding water constantly","Unexplained water bill spikes"]},
  {id:4,icon:"🔩",title:"Plumbing Repairs",tag:"Water Flows Where It Should",color:"#007EA7",
   desc:"Pool plumbing problems affect flow, filtration, pressure, and water quality. We fix it.",
   detail:"From leaking underground lines to pressure drops and air bubbles, we address the underlying cause rather than just patching symptoms.",
   signs:["Poor water circulation","Return lines not flowing right","Visible leaks at connections","Low suction at skimmer"]},
  {id:5,icon:"🛠️",title:"Equipment Repair",tag:"Your Equipment, Working Right",color:"#0077C8",
   desc:"Motors, heaters, valves, salt cells, chlorinators — we service and replace key components.",
   detail:"Pool equipment is an investment. We service motors, heaters, valves, salt cells, and chlorinators to extend life and keep your pool running efficiently.",
   signs:["Heater not warming water","Salt cell not producing chlorine","Valves stuck or inoperative","Equipment error codes or lights"]},
  {id:6,icon:"🌿",title:"Dirty Pool Cleanups",tag:"From Green to Gleaming",color:"#5BAA32",
   desc:"Green, cloudy, or neglected pool? We bring it back to swim-ready with our restoration service.",
   detail:"Whether overcome by algae or just gotten out of control, we have the tools and experience to bring your pool back to life. We'll also help you prevent it from recurring.",
   signs:["Green or black water","Visible algae on walls or floor","Extremely cloudy water","Pool neglected for a long time"]},
  {id:7,icon:"📋",title:"Routine Maintenance",tag:"Consistent Care, Clear Water",color:"#00A8E8",
   desc:"Regular maintenance prevents expensive repairs. We keep your pool clean, balanced, and ready.",
   detail:"The best pool service is preventative. Regular visits to check chemistry, clean filters, brush walls, and inspect equipment catch small issues before they become expensive.",
   signs:["Want regular service setup","Chemistry consistently off","Tired of managing chemicals","Want a stress-free pool"]},
  {id:8,icon:"🏊",title:"Pool Openings & Closings",tag:"Ready When You Are",color:"#006494",
   desc:"Seasonal opening and closing services that protect your pool and prepare it for the next season.",
   detail:"A proper opening and closing sets your pool up for success. We handle equipment startup, chemical balance, and inspection to get your pool swim-ready.",
   signs:["Pool closed for winter","Ready to open for spring/summer","Need help with cover removal","Unsure how to start up after winter"]},
];

// ═══ STORAGE ═══════════════════════════════════════════════
const safeGet = async (k, def) => { try { const r = await window.storage.get(k); return r ? JSON.parse(r.value) : def; } catch { return def; } };
const safeSet = async (k, v) => { try { await window.storage.set(k, JSON.stringify(v)); } catch (e) { console.error("Storage:", e); } };
...
function Bubble({ x, size, dur, delay }) {
  return (
    <div style={{
      ...
      background:`rgba(0,207,255,${0.04+Math.random()*0.14})`,
      border:"1px solid rgba(0,207,255,.22)",
      animation:`bubbleUp ${dur}s ease-in ${delay}s infinite`,
      pointerEvents:"none",
    }}/>
  );
}
...
function BubbleField({ count=14, z=0 }) {
  const bs = useRef([...Array(count)].map((_,i) => ({
    key:i, x:Math.random()*96, size:`${4+Math.random()*14}px`,
    dur:3.5+Math.random()*5, delay:Math.random()*6,
  })));
  return (
    <div style={{ position:"absolute",inset:0,pointerEvents:"none",zIndex:z,overflow:"hidden" }}>
      {bs.current.map(b => <Bubble key={b.key} {...b}/>)}
    </div>
  );
}
...
function GCard({ children, style={}, hover=true }) {
  return (
    <div className={`glass${hover?" hover-lift":""}`} style={{ borderRadius:16,...style }}>{children}</div>
  );
}
...
function RippleBtn({ children, onClick, bg=C.blue, color="#fff", style={}, href, type="button" }) {
  ...
  const base = {
    ...
    gap:8,fontFamily:"inherit",textDecoration:"none",transition:"filter .15s",...style,
  };
  const ripEls = rips.map(r => (
    <span key={r.id} style={{
      position:"absolute",left:r.x-16,top:r.y-16,
      width:32,height:32,borderRadius:"50%",
      background:"rgba(255,255,255,.35)",
      animation:"rippleOut .7s ease-out forwards",pointerEvents:"none",
    }}/>
  ));
...
function SHead({ label, title, sub, light=false }) {
  return (
    <div style={{ textAlign:"center",marginBottom:52 }}>
      {label && (
        <div style={{
          display:"inline-block",borderRadius:30,padding:"6px 18px",marginBottom:16,
          background:light?"rgba(0,207,255,.14)":"rgba(0,119,200,.1)",
          color:light?C.bright:C.blue,fontWeight:800,fontSize:11,
          letterSpacing:2.5,textTransform:"uppercase",
          border:`1px solid ${light?"rgba(0,207,255,.3)":"rgba(0,119,200,.2)"}`,
        }}>{label}</div>
      )}
      <h2 style={{
        fontFamily:"Bebas Neue,sans-serif",
        fontSize:"clamp(30px,5vw,52px)",letterSpacing:1.2,lineHeight:1.1,
        color:light?"#fff":C.dark,margin:"0 0 14px",
      }}>{title}</h2>
...
function LoadingScreen({ done, onDone }) {
  ...
  useEffect(() => {
    const t = setInterval(() => setProg(p => {
      ...
      if (next >= 100) {
        clearInterval(t);
        setTimeout(() => { setFading(true); setTimeout(onDone, 520); }, 400);
        return 100;
      }
      return next;
    }), 38);
  ...
  return (
    <div style={{
      position:"fixed",inset:0,zIndex:9999,background:C.ocean,overflow:"hidden",
      display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",
      transition:"opacity .55s ease",opacity:fading?0:1,pointerEvents:fading?"none":"all",
    }}>
      ...
      <div style={{
        position:"absolute",bottom:0,left:0,right:0,height:`${prog}%`,
        background:"linear-gradient(to top,rgba(0,119,200,.22),rgba(0,168,232,.08))",
        transition:"height .08s linear",borderTop:"1px solid rgba(0,207,255,.25)",
      }}/>
      ...
      <div style={{
        ...
        background:"linear-gradient(135deg,#0077C8,#00A8E8,#00CFFF)",
        display:"flex",alignItems:"center",justifyContent:"center",
        fontFamily:"Bebas Neue,sans-serif",fontSize:40,color:"#fff",
        letterSpacing:1.5,marginBottom:28,position:"relative",zIndex:1,
        animation:"glow 2.2s ease-in-out infinite",
      }}>FB</div>
      <div style={{ fontFamily:"Bebas Neue,sans-serif",fontSize:28,color:"#fff",letterSpacing:5,position:"relative",zIndex:1 }}>FOWLER BROTHERS</div>
...
function Nav({ page, setPage, scrolled }) {
  ...
  const links = [
    {id:"home",l:"Home"},{id:"services",l:"Services"},
    {id:"about",l:"About"},{id:"areas",l:"Service Areas"},
    {id:"gallery",l:"Gallery"},{id:"contact",l:"Contact"},
  ];
  return (
    <>
      <nav style={{
        position:"sticky",top:0,zIndex:500,
        background:scrolled||menu?"rgba(5,25,35,.96)":"transparent",
        backdropFilter:scrolled||menu?"blur(16px)":"none",
        WebkitBackdropFilter:scrolled||menu?"blur(16px)":"none",
        borderBottom:scrolled||menu?`1px solid ${C.glB}`:"none",
        ...
        <div style={{ maxWidth:1200,margin:"0 auto",padding:"0 24px",display:"flex",alignItems:"center",justifyContent:"space-between",height:68 }}>
          <button onClick={() => setPage("home")} style={{ background:"none",border:"none",cursor:"pointer",display:"flex",alignItems:"center",gap:12 }}>
            <div style={{
              ...
              background:"linear-gradient(135deg,#0077C8,#00CFFF)",
              display:"flex",alignItems:"center",justifyContent:"center",
              fontFamily:"Bebas Neue,sans-serif",color:"#fff",fontSize:20,letterSpacing:1.5,
              boxShadow:"0 0 18px rgba(0,207,255,.3)",flexShrink:0,
            }}>FB</div>
            <div style={{ lineHeight:1,textAlign:"left" }}>
              <div style={{ fontFamily:"Bebas Neue,sans-serif",color:"#fff",fontSize:16,letterSpacing:2 }}>FOWLER BROTHERS</div>
              <div style={{ color:C.green,fontWeight:700,fontSize:9.5,letterSpacing:2.5 }}>POOL SERVICE</div>
            </div>
          </button>
          <div style={{ display:"flex",gap:2,alignItems:"center" }} className="desk-nav">
            {links.map(l => (
              <button key={l.id} onClick={() => setPage(l.id)} style={{
                background:page===l.id?"rgba(0,119,200,.28)":"transparent",
                border:"none",color:page===l.id?"#fff":"rgba(255,255,255,.72)",
                fontWeight:page===l.id?700:500,fontSize:13.5,
                padding:"7px 13px",borderRadius:8,cursor:"pointer",
                fontFamily:"inherit",letterSpacing:.3,transition:"all .15s",
              }}>{l.l}</button>
            ))}
          </div>
          <div style={{ display:"flex",gap:10,alignItems:"center" }}>
            ...
            <button onClick={() => setMenu(!menu)} style={{
              background:"none",border:`1px solid ${C.glB}`,color:"#fff",cursor:"pointer",
              width:42,height:42,borderRadius:9,fontSize:18,
              display:"none",alignItems:"center",justifyContent:"center",fontFamily:"inherit",
            }} className="mob-ham">{menu?"✕":"☰"}</button>
          </div>
        </div>
        {menu && (
          <div style={{ background:"rgba(5,25,35,.98)",borderTop:`1px solid ${C.glB}`,padding:"10px 16px 18px" }}>
            {links.map(l => (
              <button key={l.id} onClick={() => { setPage(l.id); setMenu(false); }} style={{
                display:"block",width:"100%",textAlign:"left",
                background:page===l.id?"rgba(0,119,200,.22)":"transparent",
                border:"none",color:"#fff",fontWeight:600,fontSize:15,
                padding:"12px 14px",borderRadius:8,cursor:"pointer",marginBottom:3,fontFamily:"inherit",
              }}>{l.l}</button>
            ))}
      ...
      <div className="mob-bar" style={{ position:"fixed",bottom:0,left:0,right:0,zIndex:499,background:"rgba(5,25,35,.97)",borderTop:`2px solid ${C.blue}`,padding:"8px 12px 14px",display:"none" }}>
        <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8 }}>
          {[["📞","Call","tel:+14705890194",C.green],["💬","Text","sms:+14705890194",C.blue],["📋","Request",null,C.teal]].map(([ico,lbl,hr,bg]) => (
            hr
              ? <a key={lbl} href={hr} style={{ background:bg,color:"#fff",textAlign:"center",padding:"10px 4px",borderRadius:9,textDecoration:"none",fontWeight:700,fontSize:12,display:"block" }}>{ico} {lbl}</a>
...
function HomePage({ setPage }) {
  ...
  const faqs = [
    {q:"How do I know if my pump or filter needs repair?",a:"Common signs include unusual noises, weak water flow, leaking around the pump, or cloudy water that won't clear. Call or text us and we'll help you figure out what's going on."},
    {q:"Do you handle green or neglected pools?",a:"Yes. If your pool has turned green, cloudy, or been sitting neglected, we can help with a cleanup and guide you through what it will take to get it back in shape."},
    {q:"Do you offer routine maintenance?",a:"Yes, we provide routine maintenance to keep your pool clean, balanced, and running properly. Call or text to discuss what that looks like for your pool."},
    ...
    {q:"Can I send photos of my pool problem?",a:"Absolutely. Photos help us understand the situation before we arrive. Text them directly to (470) 589-0194 or use our contact form."},
    {q:"Do you repair heaters and motors?",a:"Yes. We service and replace motors, heaters, valves, salt cells, chlorinators, and other key equipment."},
  ];
    ...
    <>
      ...
      <div style={{ position:"relative",minHeight:"100vh",display:"flex",alignItems:"center",overflow:"hidden" }}>
        <div style={{ position:"absolute",inset:0 }}>
          <img src={IMGS.hero} alt="" style={{ width:"100%",height:"100%",objectFit:"cover",objectPosition:"center 40%" }} onError={e=>e.target.style.display="none"}/>
          ...
          <div style={{ position:"absolute",inset:0,background:"radial-gradient(ellipse at 25% 45%,rgba(0,207,255,.12) 0%,transparent 55%),radial-gradient(ellipse at 80% 25%,rgba(0,119,200,.1) 0%,transparent 40%)",animation:"caustMove 12s ease infinite",backgroundSize:"300% 300%" }}/>
        </div>
        <BubbleField count={14} z={1}/>
        <div style={{ position:"relative",zIndex:2,maxWidth:1100,margin:"0 auto",padding:"80px 24px 120px",width:"100%" }}>
          <div style={{ maxWidth:640 }}>
            <AnimIn>
              <div style={{ display:"inline-flex",alignItems:"center",gap:8,background:"rgba(91,170,50,.16)",border:"1px solid rgba(91,170,50,.42)",borderRadius:30,padding:"7px 18px",marginBottom:24,color:C.green,fontWeight:700,fontSize:12,letterSpacing:2 }}>
                📍 BUFORD &amp; NORTH GEORGIA
              </div>
            </AnimIn>
            <AnimIn delay={100}>
              <h1 style={{ fontFamily:"Bebas Neue,sans-serif",fontSize:"clamp(46px,7.5vw,86px)",color:"#fff",lineHeight:1.04,margin:"0 0 22px",letterSpacing:1.5 }}>
                LOCAL BROTHERS.<br/>
            ...
            <AnimIn delay={200}>
              <p style={{ color:"rgba(255,255,255,.8)",fontSize:"clamp(15px,2vw,18px)",lineHeight:1.8,marginBottom:36,fontWeight:300 }}>
                Fowler Brothers Pool Service helps homeowners across Buford and North Georgia with pool repairs, pump &amp; filter issues, leak detection, dirty pool cleanups, equipment service, and routine maintenance. 8 years of honest, reliable work.
              </p>
            </AnimIn>
            <AnimIn delay={300}>
              <div style={{ display:"flex",flexWrap:"wrap",gap:14,marginBottom:36 }}>
                ...
                <RippleBtn onClick={() => setPage("contact")} bg="rgba(255,255,255,.1)" style={{ padding:"15px 28px",borderRadius:12,fontSize:15,border:`1px solid ${C.glB}`,backdropFilter:"blur(8px)" }}>Request Pool Service →</RippleBtn>
              </div>
            </AnimIn>
            <AnimIn delay={420}>
              <div style={{ display:"flex",flexWrap:"wrap",gap:18 }}>
                {["8 Years Experience","Brother-Owned","North Georgia Local","Honest & Reliable"].map(t => (
                  <span key={t} style={{ color:"rgba(255,255,255,.6)",fontSize:13,display:"flex",alignItems:"center",gap:6 }}>
      ...
      <div ref={statsRef} style={{ background:C.ocean,padding:"64px 24px" }}>
        <div style={{ maxWidth:960,margin:"0 auto",display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))",gap:36,textAlign:"center" }}>
          {[
            {n:yrs,s:"+",l:"Years Experience",ico:"📅"},
            {n:cust,s:"+",l:"Happy Customers",ico:"😊"},
            {n:12,s:"",l:"Service Types",ico:"🛠️"},
            {n:"100",s:"%",l:"Local & Independent",ico:"🏡"},
          ].map(s => (
            <div key={s.l} style={{ animation:sv?"counterIn .6s ease forwards":"none",opacity:sv?1:0 }}>
      ...
      <div style={{ background:"#F0FBFF",padding:"80px 24px" }}>
        <div style={{ maxWidth:1100,margin:"0 auto" }}>
          <AnimIn><SHead label="What We Do" title="How Can We Help Your Pool?" sub="From repairs and cleanups to maintenance and equipment service — we handle it all."/></AnimIn>
          <div style={{ display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(248px,1fr))",gap:20 }}>
            {SVC.map((s,i) => (
              <AnimIn key={s.id} delay={i*55}>
                <div className="hover-lift" onClick={() => setPage("services")} style={{
                  background:"#fff",borderRadius:18,padding:"28px 24px",
                  boxShadow:"0 4px 20px rgba(0,50,100,.07)",borderTop:`4px solid ${s.color}`,
                  cursor:"pointer",height:"100%",transition:"all .2s",
                }}>
                  <div style={{ fontSize:36,marginBottom:12 }}>{s.icon}</div>
                  <h3 style={{ fontFamily:"Bebas Neue,sans-serif",fontSize:22,color:C.dark,marginBottom:4,letterSpacing:.5 }}>{s.title}</h3>
                  <div style={{ fontSize:10.5,color:s.color,fontWeight:800,letterSpacing:1.5,marginBottom:12,textTransform:"uppercase" }}>{s.tag}</div>
                  <p style={{ color:C.muted,fontSize:13.5,lineHeight:1.7,marginBottom:18 }}>{s.desc}</p>
      ...
      <div style={{ background:C.deep,padding:"80px 24px",position:"relative",overflow:"hidden" }}>
        ...
        <div style={{ maxWidth:1100,margin:"0 auto",position:"relative",zIndex:1 }}>
          <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:60,alignItems:"center" }} className="two-col">
            <div>
              <AnimIn><SHead label="Why Fowler Brothers" title="Local Service. Honest Work." sub="We're not a franchise. We're two brothers who live and work in this community." light/></AnimIn>
              <div style={{ display:"flex",flexDirection:"column",gap:14,marginBottom:36 }}>
                {[
                  {ico:"🏡",t:"Brother-owned and truly local",d:"We're not a faceless company. We live and work in North Georgia."},
                  {ico:"📅",t:"8 years of hands-on experience",d:"We've seen just about every pool issue and know how to handle it."},
                  {ico:"💬",t:"Clear communication, always",d:"We explain what's wrong, what it takes to fix it, and follow through."},
                  {ico:"✅",t:"Work we stand behind",d:"We show up when we say we will and do honest, quality work every time."},
                ].map((pt,i) => (
                  <AnimIn key={pt.t} delay={i*80}>
                    <div style={{ display:"flex",gap:16,alignItems:"flex-start" }}>
                      <span style={{ fontSize:24,flexShrink:0,marginTop:2 }}>{pt.ico}</span>
                      <div>
                        <div style={{ color:"#fff",fontWeight:700,fontSize:15,marginBottom:3 }}>{pt.t}</div>
                        <div style={{ color:"rgba(255,255,255,.5)",fontSize:13,lineHeight:1.6 }}>{pt.d}</div>
                      </div>
                    </div>
                  </AnimIn>
                ))}
              ...
              <AnimIn delay={320}>
                <div style={{ display:"flex",flexWrap:"wrap",gap:12 }}>
                  <RippleBtn onClick={() => setPage("about")} bg="rgba(255,255,255,.1)" style={{ padding:"13px 22px",borderRadius:10,border:`1px solid ${C.glB}`,fontSize:14 }}>Meet the Brothers →</RippleBtn>
                  <RippleBtn href="tel:+14705890194" bg={C.green} style={{ padding:"13px 22px",borderRadius:10,fontSize:14 }}>📞 Call or Text</RippleBtn>
                </div>
              </AnimIn>
            </div>
            <AnimIn>
              <div style={{ borderRadius:20,overflow:"hidden",boxShadow:"0 20px 60px rgba(0,0,0,.45)",border:`2px solid ${C.glB}`,animation:"float 5s ease-in-out infinite" }}>
                <img src={IMGS.hero2} alt="Pool service professionals" style={{ width:"100%",display:"block",objectFit:"cover",maxHeight:480 }}
                  onError={e=>{e.target.style.display="none";e.target.parentElement.style.minHeight="380px";e.target.parentElement.style.background="linear-gradient(135deg,#0077C8,#003554)";}}/>
              </div>
              <GCard style={{ marginTop:18,padding:"18px 22px" }}>
                <div style={{ fontFamily:"Bebas Neue,sans-serif",color:"#fff",fontSize:18,letterSpacing:1.5,marginBottom:4 }}>LOCAL. TRUSTED. BROTHER APPROVED.</div>
                <div style={{ color:C.cyan,fontSize:11,letterSpacing:2 }}>CLEAN POOLS • RELIABLE SERVICE • CLEAR RESULTS</div>
              </GCard>
            </AnimIn>
          </div>
        </div>
        ...
        <div style={{ maxWidth:820,margin:"0 auto" }}>
          ...
          <AnimIn>
            <div style={{ position:"relative" }}>
              {DEF_TESTI.map((t,i) => (
                <div key={t.id} style={{
                  display:i===ti?"block":"none",
                  background:"linear-gradient(135deg,#F0FBFF,#E2F4FF)",
                  borderRadius:22,padding:"44px 48px",
                  border:"1px solid rgba(0,119,200,.12)",
                  boxShadow:"0 10px 36px rgba(0,119,200,.1)",
                  animation:i===ti?"fadeIn .4s ease":"none",
                }}>
                  <div style={{ display:"flex",gap:3,marginBottom:18 }}>
                    {[...Array(t.rating)].map((_,j) => <span key={j} style={{ color:"#F59E0B",fontSize:24 }}>★</span>)}
                  </div>
                  <p style={{ color:C.dark,fontSize:18,lineHeight:1.85,fontStyle:"italic",marginBottom:26 }}>"{t.text}"</p>
                  <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center" }}>
                    <div>
                      <div style={{ fontWeight:800,color:C.dark,fontSize:16 }}>{t.name}</div>
                      <div style={{ color:C.muted,fontSize:13 }}>{t.loc}</div>
                    </div>
              ...
              <div style={{ display:"flex",gap:8,justifyContent:"center",marginTop:24 }}>
                {DEF_TESTI.map((_,i) => (
                  <button key={i} onClick={() => setTi(i)} style={{ height:10,width:i===ti?28:10,borderRadius:5,border:"none",background:i===ti?C.blue:"rgba(0,119,200,.22)",cursor:"pointer",transition:"all .2s" }}/>
                ))}
              </div>
            </div>
          </AnimIn>
      ...
      {/* SERVICE AREA BAND */}
      <div style={{ background:`linear-gradient(135deg,${C.blue},${C.navy})`,padding:"64px 24px",textAlign:"center",position:"relative",overflow:"hidden" }}>
        <BubbleField count={8}/>
        <div style={{ maxWidth:800,margin:"0 auto",position:"relative",zIndex:1 }}>
          <AnimIn><h2 style={{ fontFamily:"Bebas Neue,sans-serif",fontSize:"clamp(28px,4.5vw,48px)",color:"#fff",margin:"0 0 14px",letterSpacing:1.5 }}>SERVING BUFORD &amp; SURROUNDING NORTH GEORGIA</h2></AnimIn>
          <AnimIn delay={100}><p style={{ color:"rgba(255,255,255,.78)",fontSize:16,lineHeight:1.75,marginBottom:24 }}>Buford · Sugar Hill · Duluth · Cumming · Braselton · Gainesville · Dawsonville · Dahlonega · Atlanta &amp; more</p></AnimIn>
          <AnimIn delay={200}>
            <div style={{ background:"rgba(255,255,255,.1)",borderRadius:12,padding:"14px 22px",display:"inline-block",color:"rgba(255,255,255,.8)",fontSize:14,border:"1px solid rgba(255,255,255,.2)",marginBottom:28 }}>
              Not sure if we cover your area? <strong style={{ color:C.green }}>Call or text and we'll let you know.</strong>
            </div>
          </AnimIn>
          <AnimIn delay={300}>
            <div style={{ display:"flex",gap:14,justifyContent:"center",flexWrap:"wrap" }}>
              <RippleBtn href="tel:+14705890194" bg={C.green} style={{ padding:"13px 26px",borderRadius:11,fontSize:15 }}>📞 (470) 589-0194</RippleBtn>
              <RippleBtn onClick={() => setPage("areas")} bg="rgba(255,255,255,.12)" style={{ padding:"13px 26px",borderRadius:11,fontSize:15,border:`1px solid rgba(255,255,255,.25)` }}>See All Service Areas →</RippleBtn>
            </div>
          </AnimIn>
        </div>
      </div>
      ...
      <div style={{ background:`linear-gradient(135deg,${C.navy},${C.pool})`,padding:"80px 24px",textAlign:"center",position:"relative",overflow:"hidden" }}>
        ...
        <div style={{ position:"relative",zIndex:1,maxWidth:680,margin:"0 auto" }}>
          <div style={{ fontSize:60,marginBottom:20,animation:"float 4s ease-in-out infinite" }}>🏊</div>
...
function ServicesPage({ setPage }) {
  ...
  return (
    <>
      <div style={{ background:`linear-gradient(135deg,${C.navy},${C.ocean})`,padding:"80px 24px 70px",position:"relative",overflow:"hidden" }}>
        <BubbleField count={10}/>
        <div style={{ maxWidth:720,margin:"0 auto",textAlign:"center",position:"relative",zIndex:1 }}>
          <AnimIn><div style={{ display:"inline-block",background:"rgba(0,207,255,.12)",color:C.bright,fontWeight:800,fontSize:11,letterSpacing:2.5,padding:"6px 18px",borderRadius:20,marginBottom:18,border:"1px solid rgba(0,207,255,.25)" }}>BUFORD &amp; NORTH GEORGIA</div></AnimIn>
          <AnimIn delay={80}><h1 style={{ fontFamily:"Bebas Neue,sans-serif",fontSize:"clamp(36px,6vw,64px)",color:"#fff",margin:"0 0 18px",letterSpacing:1.5 }}>POOL SERVICES</h1></AnimIn>
          <AnimIn delay={160}><p style={{ color:"rgba(255,255,255,.7)",fontSize:17,lineHeight:1.75 }}>From routine maintenance to repairs, cleanups, and equipment service — we help homeowners keep their pools clean, clear, and working properly.</p></AnimIn>
        </div>
      </div>
          ...
          {SVC.map((s,i) => (
            <AnimIn key={s.id} delay={i*40}>
              <div className="hover-lift" style={{
                ...
                boxShadow:"0 4px 20px rgba(0,50,100,.08)",
                border:`1px solid ${active===s.id?"rgba(0,119,200,.3)":"rgba(0,0,0,.06)"}`,
                ...
                <div style={{ display:"grid",gridTemplateColumns:"8px 1fr auto",alignItems:"center" }}>
                  ...
                  <div style={{ padding:"26px 28px 26px 22px",display:"grid",gridTemplateColumns:"72px 1fr auto",gap:20,alignItems:"center" }}>
                    <div style={{ width:64,height:64,borderRadius:14,background:`${s.color}18`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:30,flexShrink:0 }}>{s.icon}</div>
                    <div>
    ...
    <>
      <div style={{ background:`linear-gradient(135deg,${C.navy},${C.ocean})`,padding:"80px 24px",position:"relative",overflow:"hidden" }}>
        ...
        <div style={{ maxWidth:700,margin:"0 auto",textAlign:"center",position:"relative",zIndex:1 }}>
          <AnimIn><h1 style={{ fontFamily:"Bebas Neue,sans-serif",fontSize:"clamp(36px,6vw,64px)",color:"#fff",margin:"0 0 18px",letterSpacing:1.5 }}>LOCAL BROTHERS.<br/><span style={{ color:C.cyan }}>RELIABLE SERVICE.</span></h1></AnimIn>
          <AnimIn delay={80}><p style={{ color:"rgba(255,255,255,.75)",fontSize:17,lineHeight:1.75 }}>Fowler Brothers Pool Service is built on clean work, reliable communication, and clear results.</p></AnimIn>
        </div>
      </div>
      <WaveDiv topColor={C.ocean} botColor="#fff"/>
      <div style={{ background:"#fff",padding:"80px 24px" }}>
        <div style={{ maxWidth:1100,margin:"0 auto",display:"grid",gridTemplateColumns:"1fr 1fr",gap:64,alignItems:"start" }} className="two-col">
          <AnimIn>
            <div style={{ borderRadius:20,overflow:"hidden",boxShadow:"0 16px 50px rgba(0,50,100,.15)",marginBottom:20 }}>
              <img src={IMGS.hero2} alt="Fowler Brothers" style={{ width:"100%",display:"block",objectFit:"cover",maxHeight:440 }} onError={e=>{e.target.style.display="none";}}/>
            </div>
            <div style={{ background:`linear-gradient(135deg,${C.pool},${C.navy})`,borderRadius:16,padding:"24px",textAlign:"center" }}>
              <div style={{ fontFamily:"Bebas Neue,sans-serif",color:"#fff",fontSize:20,letterSpacing:2,marginBottom:4 }}>LOCAL. TRUSTED. BROTHER APPROVED.</div>
              <div style={{ color:C.cyan,fontSize:11,letterSpacing:3 }}>CLEAN POOLS • RELIABLE SERVICE • CLEAR RESULTS</div>
            </div>
          </AnimIn>
          <div>
            ...
            <AnimIn delay={120}><p style={{ color:C.muted,fontSize:15,lineHeight:1.9,marginBottom:18 }}>Fowler Brothers Pool Service is a local, brother-owned pool service company built on clean work, reliable communication, and clear results. With 8 years of experience, we help homeowners with pool repairs, maintenance, equipment issues, plumbing repairs, leak detection, dirty pool cleanups, and more.</p></AnimIn>
            <AnimIn delay={160}><p style={{ color:C.muted,fontSize:15,lineHeight:1.9,marginBottom:28 }}>We know homeowners want someone they can trust around their home and pool. That's why our approach is simple: show up, communicate clearly, do honest work, and help keep your pool in top shape.</p></AnimIn>
            <AnimIn delay={200}>
              <div style={{ background:"#F0FBFF",borderRadius:16,padding:"24px",marginBottom:28 }}>
                ...
                {["Be easy to reach","Communicate clearly before and after the job","Respect the homeowner's property","Explain the issue without confusing jargon","Offer practical repair options","Do work we can stand behind"].map(pt => (
                  <div key={pt} style={{ display:"flex",gap:10,marginBottom:10,color:C.dark,fontSize:14,fontWeight:500 }}>
      ...
      <div style={{ background:C.deep,padding:"72px 24px" }}>
        <div style={{ maxWidth:1000,margin:"0 auto" }}>
          <AnimIn><SHead label="Our Values" title="How We Work" light sub="Simple expectations, consistently delivered."/></AnimIn>
          <div style={{ display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))",gap:18 }}>
            {[
              {ico:"📞",t:"Easy to Reach",d:"Call or text us. We respond promptly and keep you updated throughout the job."},
              {ico:"🏡",t:"Respectful",d:"We treat your property with care and leave things better than we found them."},
              ...
              {ico:"📍",t:"Truly Local",d:"We're not a franchise. We live and work in this community."},
              {ico:"🔧",t:"Hands-On Expertise",d:"8 years of real-world experience across repairs, maintenance, and equipment."},
            ].map(v => (
              <AnimIn key={v.t}>
                <GCard style={{ padding:"24px 20px" }}>
                  <div style={{ fontSize:32,marginBottom:10 }}>{v.ico}</div>
                  <div style={{ color:"#fff",fontWeight:700,fontSize:14,marginBottom:6 }}>{v.t}</div>
                  <div style={{ color:"rgba(255,255,255,.5)",fontSize:13,lineHeight:1.6 }}>{v.d}</div>
                </GCard>
              </AnimIn>
            ))}
          </div>
...
function AreasPage({ setPage }) {
  ...
  const cities = [
    ...
    {city:"Sugar Hill, GA",desc:"Pool repair and maintenance services for Sugar Hill residents, just a short drive from our base."},
    {city:"Duluth, GA",desc:"Pool service, equipment repairs, and routine maintenance serving Duluth and surrounding neighborhoods."},
    {city:"Cumming, GA",desc:"Pool maintenance, leak detection, and equipment service for Cumming homeowners."},
    {city:"Braselton, GA",desc:"Pool leak detection, pump repair, and maintenance services in the Braselton area."},
    {city:"Gainesville, GA",desc:"Pool equipment repair, heater and motor service, and routine maintenance for Gainesville homeowners."},
    {city:"Dawsonville, GA",desc:"Pool repair and maintenance serving Dawsonville and surrounding communities."},
    {city:"Dahlonega, GA",desc:"Pool service available in Dahlonega and surrounding North Georgia mountain communities."},
  ];
  return (
    <>
      <div style={{ background:`linear-gradient(135deg,${C.navy},${C.ocean})`,padding:"80px 24px",position:"relative",overflow:"hidden" }}>
        <BubbleField count={8}/>
        <div style={{ maxWidth:700,margin:"0 auto",textAlign:"center",position:"relative",zIndex:1 }}>
          <AnimIn><h1 style={{ fontFamily:"Bebas Neue,sans-serif",fontSize:"clamp(36px,6vw,62px)",color:"#fff",margin:"0 0 18px",letterSpacing:1.5 }}>SERVICE AREAS IN<br/><span style={{ color:C.cyan }}>NORTH GEORGIA</span></h1></AnimIn>
          <AnimIn delay={80}><p style={{ color:"rgba(255,255,255,.7)",fontSize:16,lineHeight:1.75,marginBottom:24 }}>Pool repair, maintenance, leak detection, and equipment service across Buford and surrounding communities.</p></AnimIn>
          <AnimIn delay={160}>
            <div style={{ background:"rgba(91,170,50,.15)",border:"1px solid rgba(91,170,50,.35)",borderRadius:12,padding:"14px 22px",display:"inline-block",color:"rgba(255,255,255,.8)",fontSize:14 }}>
              Not sure if we cover your area? <strong style={{ color:C.green }}>Call or text — we'll let you know.</strong>
            </div>
          </AnimIn>
        </div>
      </div>
        ...
        <div style={{ maxWidth:1100,margin:"0 auto" }}>
              ...
              <AnimIn key={a.city}>
                <div className="hover-lift" style={{ background:"#fff",borderRadius:16,padding:"26px 22px",boxShadow:"0 4px 16px rgba(0,50,100,.07)",borderLeft:`5px solid ${C.blue}` }}>
                  <div style={{ display:"flex",gap:10,alignItems:"center",marginBottom:10 }}>
                    ...
                    <h3 style={{ fontWeight:800,fontSize:17,color:C.dark }}>{a.city}</h3>
                  </div>
          ...
          <AnimIn>
            <div style={{ background:`linear-gradient(135deg,${C.blue},${C.pool})`,borderRadius:18,padding:"32px",textAlign:"center" }}>
              <h3 style={{ color:"#fff",fontWeight:800,fontSize:20,marginBottom:10 }}>Also Serving Nearby Areas</h3>
              <p style={{ color:"rgba(255,255,255,.8)",fontSize:14,marginBottom:22,lineHeight:1.7 }}>We serve Atlanta and many surrounding North Georgia communities. Don't see your city? Call or text us — chances are we can help.</p>
              <RippleBtn href="tel:+14705890194" bg={C.green} style={{ padding:"12px 24px",borderRadius:10,fontSize:14 }}>📞 (470) 589-0194 — Call or Text</RippleBtn>
            </div>
          </AnimIn>
        </div>
      </div>
...
function ContactPage() {
  ...
  const svcOpts = ["Pool Repair","Pump & Filter Repair","Leak Detection","Plumbing Repair","Equipment Repair","Motor Replacement","Heater Replacement","Valve Replacement","Salt Cell / Chlorinator","Dirty Pool Cleanup","Algae Removal","Routine Maintenance","Pool Opening","Pool Closing","Other"];
  ...
  const handleSubmit = async e => {
    ...
    try {
      const body = new URLSearchParams({
        "form-name":"pool-service-request",
        ...Object.fromEntries(Object.entries(form).map(([k,v]) => [k,Array.isArray(v)?v.join(", "):v])),
      }).toString();
  ...
  return (
    <>
      <div style={{ background:`linear-gradient(135deg,${C.navy},${C.ocean})`,padding:"80px 24px",position:"relative",overflow:"hidden" }}>
        <BubbleField count={8}/>
        <div style={{ maxWidth:700,margin:"0 auto",textAlign:"center",position:"relative",zIndex:1 }}>
          <AnimIn><h1 style={{ fontFamily:"Bebas Neue,sans-serif",fontSize:"clamp(36px,6vw,62px)",color:"#fff",margin:"0 0 18px",letterSpacing:1.5 }}>REQUEST<br/><span style={{ color:C.cyan }}>POOL SERVICE</span></h1></AnimIn>
          <AnimIn delay={80}><p style={{ color:"rgba(255,255,255,.7)",fontSize:16,lineHeight:1.75 }}>Tell us what's going on with your pool and we'll follow up as soon as possible. Photos are very helpful.</p></AnimIn>
        </div>
      </div>
      <WaveDiv topColor={C.ocean} botColor="#F0FBFF"/>
      <div style={{ background:"#F0FBFF",padding:"72px 24px" }}>
        <div style={{ maxWidth:1100,margin:"0 auto",display:"grid",gridTemplateColumns:"300px 1fr",gap:40,alignItems:"start" }} className="two-col">
          ...
          <div style={{ display:"flex",flexDirection:"column",gap:14,position:"sticky",top:90 }}>
            {[
              ...
              <a key={c.t} href={c.href} target={c.href.startsWith("http")?"_blank":"_self"} rel="noopener noreferrer" style={{ background:"#fff",borderRadius:14,padding:"18px 20px",textDecoration:"none",boxShadow:"0 4px 14px rgba(0,50,100,.08)",display:"flex",alignItems:"center",gap:14,borderLeft:`5px solid ${c.bg}`,transition:"transform .15s,box-shadow .15s" }}
                onMouseEnter={e=>{e.currentTarget.style.transform="translateX(4px)";e.currentTarget.style.boxShadow="0 6px 20px rgba(0,50,100,.13)";}}
                onMouseLeave={e=>{e.currentTarget.style.transform="";e.currentTarget.style.boxShadow="0 4px 14px rgba(0,50,100,.08)";}}>
          ...
          <AnimIn>
            ...
            <form onSubmit={handleSubmit} style={{ background:"#fff",borderRadius:20,padding:"40px 36px",boxShadow:"0 8px 30px rgba(0,50,100,.08)" }}>
              ...
              <div style={{ marginBottom:16 }}>
                <label style={{ display:"block",fontWeight:700,fontSize:13,color:C.dark,marginBottom:8 }}>What do you need help with? <span style={{ fontWeight:400,color:C.muted }}>(select all that apply)</span></label>
              ...
              <div style={{ background:"#F0FBFF",borderRadius:10,padding:"14px 16px",marginBottom:22,fontSize:12.5,color:C.muted,border:"1px solid rgba(0,119,200,.12)" }}>
                📎 <strong>To include photos:</strong> Text them directly to <a href="sms:+14705890194" style={{ color:C.blue,fontWeight:700 }}>(470) 589-0194</a>, or use Netlify Forms / Formspree with file upload support on the live site.
              </div>
              <RippleBtn bg={C.blue} style={{ width:"100%",padding:"17px",borderRadius:12,fontSize:16,fontWeight:800,boxShadow:"0 6px 22px rgba(0,119,200,.35)" }} onClick={handleSubmit}>
...
function AdminPage() {
  ...
  const [settings, setSettings] = useState({phone1:"(470) 589-0194",phone2:"(470) 650-5028",email:"fowlerbrotherspoolservice@gmail.com",fb:"https://www.facebook.com/profile.php?id=61566480455878",tagline:"Clean Pools. Reliable Service. Clear Results."});
  const [svcs, setSvcs] = useState(SVC.map(s=>({...s})));
  const [np, setNp] = useState({url:"",title:"",category:"After"});
  ...
  useEffect(() => {
    ...
    safeGet("services-data",SVC.map(s=>({...s}))).then(setSvcs);
  }, [loggedIn]);

  const toast_ = msg => { setToast(msg); setTimeout(()=>setToast(null),3000); };
  const saveGallery = async g => { setGallery(g); await safeSet("gallery-items",g); toast_("Gallery saved ✓"); };
  const saveTesti = async t => { setTesti(t); await safeSet("testimonials",t); toast_("Testimonials saved ✓"); };
  const saveSvcs = async s => { setSvcs(s); await safeSet("services-data",s); toast_("Services saved ✓"); };
    ...
    <div style={{ minHeight:"100vh",background:C.ocean,display:"flex",alignItems:"center",justifyContent:"center",padding:24,position:"relative",overflow:"hidden" }}>
      ...
      <div style={{ background:"rgba(255,255,255,.06)",backdropFilter:"blur(14px)",border:`1px solid ${C.glB}`,borderRadius:24,padding:"48px 44px",maxWidth:420,width:"100%",position:"relative",zIndex:1 }}>
        <div style={{ textAlign:"center",marginBottom:36 }}>
          <div style={{ width:72,height:72,borderRadius:"50%",background:"linear-gradient(135deg,#0077C8,#00CFFF)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:26,fontFamily:"Bebas Neue,sans-serif",color:"#fff",margin:"0 auto 16px",boxShadow:"0 0 30px rgba(0,207,255,.35)" }}>FB</div>
          <div style={{ fontFamily:"Bebas Neue,sans-serif",color:"#fff",fontSize:24,letterSpacing:2 }}>ADMIN ACCESS</div>
          <div style={{ color:"rgba(255,255,255,.5)",fontSize:13,marginTop:4 }}>Fowler Brothers Pool Service</div>
        </div>
        <form onSubmit={e=>{e.preventDefault();if(lf.u===ADM.u&&lf.p===ADM.p){setLoggedIn(true);setLerr("");}else setLerr("Invalid username or password.");}}>
          <div style={{ marginBottom:16 }}>
            <label style={{ display:"block",color:"rgba(255,255,255,.7)",fontSize:12,fontWeight:700,letterSpacing:.5,marginBottom:7 }}>USERNAME</label>
            <input style={{ width:"100%",padding:"12px 14px",borderRadius:10,border:`1px solid ${C.glB}`,background:"rgba(255,255,255,.08)",color:"#fff",fontSize:14,outline:"none",fontFamily:"inherit",boxSizing:"border-box" }} value={lf.u} onChange={e=>setLf({...lf,u:e.target.value})} placeholder="Username"/>
          </div>
          <div style={{ marginBottom:22 }}>
            <label style={{ display:"block",color:"rgba(255,255,255,.7)",fontSize:12,fontWeight:700,letterSpacing:.5,marginBottom:7 }}>PASSWORD</label>
            <input type="password" style={{ width:"100%",padding:"12px 14px",borderRadius:10,border:`1px solid ${lerr?"#ef4444":C.glB}`,background:"rgba(255,255,255,.08)",color:"#fff",fontSize:14,outline:"none",fontFamily:"inherit",boxSizing:"border-box" }} value={lf.p} onChange={e=>setLf({...lf,p:e.target.value})} placeholder="Password"/>
          </div>
    ...
    <div style={{ minHeight:"100vh",background:"#F0F4F8",fontFamily:"inherit" }}>
      ...
      <div style={{ background:"#fff",borderBottom:"1px solid #E2EBF4",padding:"14px 24px",display:"flex",alignItems:"center",justifyContent:"space-between",position:"sticky",top:0,zIndex:100,boxShadow:"0 2px 8px rgba(0,0,0,.06)" }}>
        <div style={{ display:"flex",alignItems:"center",gap:14 }}>
          <div style={{ width:40,height:40,borderRadius:10,background:"linear-gradient(135deg,#0077C8,#00CFFF)",display:"flex",alignItems:"center",justifyContent:"center",color:"#fff",fontFamily:"Bebas Neue,sans-serif",fontSize:17,letterSpacing:1 }}>FB</div>
      ...
      <div style={{ maxWidth:1100,margin:"0 auto",padding:"32px 24px" }}>
        ...
        <div style={{ background:"#fff",borderRadius:14,padding:"8px",display:"inline-flex",gap:4,marginBottom:28,boxShadow:"0 2px 10px rgba(0,0,0,.07)" }}>
          {[["gallery","🖼 Gallery"],["testimonials","⭐ Reviews"],["services","🔧 Services"],["settings","⚙ Settings"]].map(([id,lbl]) => (
        ...
        {/* GALLERY TAB */}
        {tab==="gallery" && (
          <div style={{ display:"grid",gridTemplateColumns:"2fr 1fr",gap:24,alignItems:"start" }} className="two-col">
            <div>
              <div style={{ fontWeight:800,fontSize:17,color:"#1a2a3a",marginBottom:20 }}>Gallery Photos ({gallery.length})</div>
              <div style={{ display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(180px,1fr))",gap:14 }}>
                {gallery.map(img => (
                  <div key={img.id} style={{ background:"#fff",borderRadius:12,overflow:"hidden",boxShadow:"0 2px 10px rgba(0,0,0,.07)" }}>
                    <div style={{ position:"relative",paddingBottom:"70%",overflow:"hidden" }}>
                      <img src={img.url} alt={img.title} style={{ position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover" }} onError={e=>{e.target.src="https://placehold.co/300x200/003554/00CFFF?text=IMG";}}/>
                      {img.featured && <span style={{ position:"absolute",top:8,right:8,background:"#F59E0B",color:"#fff",fontSize:10,fontWeight:700,padding:"3px 8px",borderRadius:6 }}>FEATURED</span>}
                    </div>
                    <div style={{ padding:"12px 12px 8px" }}>
                      <div style={{ fontWeight:700,fontSize:12,color:"#1a2a3a",marginBottom:3,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap" }}>{img.title}</div>
                      <div style={{ fontSize:11,color:"#6B8CAA",marginBottom:10 }}>{img.category}</div>
                      <div style={{ display:"flex",gap:6 }}>
                        <button onClick={() => saveGallery(gallery.map(g=>g.id===img.id?{...g,featured:!g.featured}:g))} style={{ flex:1,background:img.featured?"#FEF3C7":"#F0FBFF",border:"none",color:img.featured?"#B45309":C.blue,fontSize:11,fontWeight:600,padding:"5px",borderRadius:6,cursor:"pointer",fontFamily:"inherit" }}>{img.featured?"★ Unfeature":"☆ Feature"}</button>
                        <button onClick={() => saveGallery(gallery.filter(g=>g.id!==img.id))} style={{ background:"#FEF2F2",border:"none",color:"#DC2626",padding:"5px 8px",borderRadius:6,cursor:"pointer",fontSize:13,fontFamily:"inherit" }}>🗑</button>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div style={{ background:"#fff",borderRadius:16,padding:"24px",boxShadow:"0 2px 10px rgba(0,0,0,.07)",position:"sticky",top:90 }}>
              <div style={{ fontWeight:800,fontSize:15,color:"#1a2a3a",marginBottom:20 }}>Add New Photo</div>
              <div style={{ marginBottom:12 }}><label style={{ display:"block",fontWeight:700,fontSize:12,color:"#6B8CAA",marginBottom:5 }}>IMAGE URL</label><input style={inpA} value={np.url} onChange={e=>setNp({...np,url:e.target.value})} placeholder="https://..."/></div>
              {np.url && <div style={{ borderRadius:10,overflow:"hidden",marginBottom:12 }}><img src={np.url} alt="Preview" style={{ width:"100%",maxHeight:160,objectFit:"cover" }} onError={e=>e.target.style.display="none"}/></div>}
              <div style={{ marginBottom:12 }}><label style={{ display:"block",fontWeight:700,fontSize:12,color:"#6B8CAA",marginBottom:5 }}>TITLE</label><input style={inpA} value={np.title} onChange={e=>setNp({...np,title:e.target.value})} placeholder="Photo title"/></div>
              <div style={{ marginBottom:18 }}><label style={{ display:"block",fontWeight:700,fontSize:12,color:"#6B8CAA",marginBottom:5 }}>CATEGORY</label><select style={{ ...inpA,appearance:"auto" }} value={np.category} onChange={e=>setNp({...np,category:e.target.value})}>{["Before","After","Service","Equipment","Before/After"].map(c=><option key={c}>{c}</option>)}</select></div>
              <RippleBtn bg={C.blue} style={{ width:"100%",padding:"12px",borderRadius:10,fontSize:14 }} onClick={()=>{if(!np.url)return;saveGallery([...gallery,{id:Date.now(),...np,featured:false}]);setNp({url:"",title:"",category:"After"});}}>Add Photo +</RippleBtn>
            </div>
          </div>
        )}
        ...
        {tab==="testimonials" && (
          <div style={{ display:"grid",gridTemplateColumns:"1fr 320px",gap:24,alignItems:"start" }} className="two-col">
            <div>
              <div style={{ fontWeight:800,fontSize:17,color:"#1a2a3a",marginBottom:20 }}>Reviews ({testi.length})</div>
              {testi.map(t => (
                <div key={t.id} style={{ background:"#fff",borderRadius:16,padding:"22px",marginBottom:14,boxShadow:"0 2px 10px rgba(0,0,0,.07)" }}>
                  {editT===t.id ? (
                    <div>
                      <input style={{ ...inpA,marginBottom:8 }} value={t.name} onChange={e=>setTesti(testi.map(x=>x.id===t.id?{...x,name:e.target.value}:x))} placeholder="Name"/>
                      <input style={{ ...inpA,marginBottom:8 }} value={t.loc} onChange={e=>setTesti(testi.map(x=>x.id===t.id?{...x,loc:e.target.value}:x))} placeholder="Location"/>
                      <div style={{ display:"flex",gap:8,marginBottom:8 }}>
                        {[1,2,3,4,5].map(r=><button key={r} type="button" onClick={()=>setTesti(testi.map(x=>x.id===t.id?{...x,rating:r}:x))} style={{ fontSize:22,background:"none",border:"none",cursor:"pointer",color:r<=t.rating?"#F59E0B":"#D0D0D0" }}>★</button>)}
                      </div>
                    ...
                    <div>
                      <div style={{ display:"flex",justifyContent:"space-between",alignItems:"start",marginBottom:10 }}>
                        <div>
                          <div style={{ fontWeight:800,fontSize:15,color:"#1a2a3a" }}>{t.name}</div>
                          <div style={{ fontSize:12,color:"#6B8CAA" }}>{t.loc} · {t.date}</div>
                        </div>
                        <div style={{ display:"flex",gap:6 }}>
        ...
        {tab==="services" && (
          <div>
            <div style={{ fontWeight:800,fontSize:17,color:"#1a2a3a",marginBottom:20 }}>Edit Service Descriptions</div>
            <div style={{ display:"flex",flexDirection:"column",gap:16 }}>
              {svcs.map((s,i) => (
                <div key={s.id} style={{ background:"#fff",borderRadius:16,padding:"22px",boxShadow:"0 2px 10px rgba(0,0,0,.07)" }}>
                  <div style={{ display:"flex",alignItems:"center",gap:12,marginBottom:14 }}>
                    <span style={{ fontSize:28 }}>{s.icon}</span>
                    <div style={{ fontFamily:"Bebas Neue,sans-serif",fontSize:22,color:"#1a2a3a",letterSpacing:.5 }}>{s.title}</div>
                  </div>
                  <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:12 }} className="two-col">
                    <div><label style={{ display:"block",fontWeight:700,fontSize:11,color:"#6B8CAA",marginBottom:5,textTransform:"uppercase",letterSpacing:.5 }}>Tagline</label><input style={inpA} value={s.tag} onChange={e=>setSvcs(svcs.map((x,j)=>j===i?{...x,tag:e.target.value}:x))}/></div>
                    <div></div>
                    <div><label style={{ display:"block",fontWeight:700,fontSize:11,color:"#6B8CAA",marginBottom:5,textTransform:"uppercase",letterSpacing:.5 }}>Short Description</label><textarea style={{ ...inpA,minHeight:70,resize:"vertical" }} value={s.desc} onChange={e=>setSvcs(svcs.map((x,j)=>j===i?{...x,desc:e.target.value}:x))}/></div>
                    <div><label style={{ display:"block",fontWeight:700,fontSize:11,color:"#6B8CAA",marginBottom:5,textTransform:"uppercase",letterSpacing:.5 }}>Detail Text</label><textarea style={{ ...inpA,minHeight:70,resize:"vertical" }} value={s.detail} onChange={e=>setSvcs(svcs.map((x,j)=>j===i?{...x,detail:e.target.value}:x))}/></div>
                  </div>
                </div>
              ))}
            </div>
            <div style={{ marginTop:20,textAlign:"right" }}>
              <RippleBtn bg={C.green} style={{ padding:"12px 28px",borderRadius:11,fontSize:15 }} onClick={() => saveSvcs(svcs)}>Save All Services ✓</RippleBtn>
            </div>
          </div>
        )}
        ...
        {tab==="settings" && (
          <div style={{ maxWidth:640 }}>
            ...
            <div style={{ background:"#fff",borderRadius:16,padding:"28px",boxShadow:"0 2px 10px rgba(0,0,0,.07)" }}>
              {[{k:"phone1",l:"Primary Phone"},{k:"phone2",l:"Secondary Phone"},{k:"email",l:"Email Address"},{k:"fb",l:"Facebook URL"},{k:"tagline",l:"Site Tagline"}].map(f => (
      ...
      {toast && (
        <div style={{ position:"fixed",bottom:28,right:28,background:C.green,color:"#fff",fontWeight:700,padding:"14px 22px",borderRadius:12,boxShadow:"0 8px 24px rgba(0,0,0,.2)",zIndex:999,animation:"fadeUp .2s ease",fontSize:14 }}>{toast}</div>
      )}
    </div>
  );
}
  ...
  return (
    <footer style={{ background:C.ocean,color:"#fff",paddingBottom:80 }}>
      ...
      <div style={{ maxWidth:1200,margin:"0 auto",padding:"56px 24px 40px",display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(190px,1fr))",gap:44 }}>
        <div>
          <div style={{ fontFamily:"Bebas Neue,sans-serif",fontSize:22,color:C.green,letterSpacing:2,marginBottom:6 }}>FOWLER BROTHERS</div>
          <div style={{ fontWeight:700,fontSize:11,color:C.cyan,letterSpacing:3,marginBottom:16 }}>POOL SERVICE</div>
        ...
        <div>
          ...
          {["Pool Repairs","Pump & Filter","Leak Detection","Equipment Repair","Dirty Cleanups","Maintenance","Pool Openings"].map(s => (
            <button key={s} onClick={() => setPage("services")} style={{ display:"block",background:"none",border:"none",color:"rgba(255,255,255,.55)",fontSize:13,padding:"3px 0",cursor:"pointer",fontFamily:"inherit",textAlign:"left",marginBottom:4 }}>{s}</button>
          ))}
        </div>
        <div>
          <div style={{ fontFamily:"Bebas Neue,sans-serif",fontSize:16,color:C.green,letterSpacing:1,marginBottom:16 }}>SERVICE AREAS</div>
          <div style={{ color:"rgba(255,255,255,.55)",fontSize:13,lineHeight:2.1 }}>Buford · Sugar Hill<br/>Duluth · Cumming<br/>Braselton · Gainesville<br/>Dawsonville · Dahlonega<br/>Atlanta &amp; nearby</div>
        </div>
      </div>
...
export default function App() {
  ...
  const navigate = useCallback(p => {
    ...
    const titles = {
      home:"Fowler Brothers Pool Service | Pool Repair & Maintenance in Buford, GA",
      services:"Pool Services | Fowler Brothers",about:"About Us | Fowler Brothers",
      areas:"Service Areas | Fowler Brothers",gallery:"Gallery | Fowler Brothers",
      contact:"Request Service | Fowler Brothers",admin:"Admin | Fowler Brothers",
    };
  ...
  const pages = {
    ...
    areas:<AreasPage setPage={navigate}/>,
    gallery:<GalleryPage/>,
    contact:<ContactPage/>,
    admin:<AdminPage/>,
  };
    ...
    <>
      ...
      {loadDone && (
        <div style={{ minHeight:"100vh" }}>
          ...
          {/* Hidden admin link — small gear in bottom corner */}
          <div
            title="Admin"
            onClick={() => navigate("admin")}
            style={{ position:"fixed",bottom:page!=="admin"?86:8,right:8,fontSize:13,color:"rgba(255,255,255,.12)",cursor:"pointer",zIndex:100,padding:4,transition:"color .2s" }}
            onMouseEnter={e=>e.currentTarget.style.color="rgba(255,255,255,.4)"}
            onMouseLeave={e=>e.currentTarget.style.color="rgba(255,255,255,.12)"}
          >⚙</div>
        </div>
      )}
    </>
